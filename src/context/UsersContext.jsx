...
export const UsersProvider = ({children}) => {
    ...
    useEffect(() => {
        const obtenerNoticias = async() => {
          ...
          try {
            ...
            const url = 'http://10.12.100.248:8000/api/noticias_area';
    ...
    useEffect(() => {
      ...
      const guardarNoticia = async(noticia, id) => {
        ...
        if (id) {
          const urlEdit = `http://10.12.100.248:8000/api/noticia_update/${id}`
            const token = localStorage.getItem('token');
            try {
          ...
          try {
              const url = 'http://10.12.100.248:8000/api/noticia_create';
          const token = localStorage.getItem('token');
