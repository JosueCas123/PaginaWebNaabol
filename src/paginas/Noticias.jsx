  ...
  return (
    <>
      ...
      <div className="w-11/12 md:w-11/12 mt-5 mx-auto">
        ...
        <div
          className="w-auto h-96 items-center my-10 overflow-x-auto overscroll-x-contain  space-x-6  flex justify-center md:flex md:space-x-5 box-border mx-auto hidden:space-y-5 overflow-hidden"
        ...
        <div className="bg-gray-700 w"></div>
      </div>
      <NoticiaVer />
      <Foot />
    </>
