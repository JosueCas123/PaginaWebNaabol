...
export const NoticiaVer = () => {
  return (
    <>
      <section className=" py-8 w-11/12 mx-auto max-w-7xl">
        <div className="md:flex justify-between">
          ...
          <div className="md:w-1/3  md:py-14 ">
            ...
            <div className=" my-5 p-2 flex flex-col items-center justify-center md:flex md:flex-col md:items-center lg:flex-row">
              <img
                src="../src/img/nn1.png"
                alt=""
              ...
              />
              <di className="lg:p-1">
                <h5 className="sm:text-center sm:font-bold sm:my-2 ">
            ...
            <div className=" my-5 p-2 flex flex-col items-center justify-center md:flex md:flex-col md:items-center lg:flex-row">
              <img
                src="../src/img/nn1.png"
                alt=""
                className="w-32 mr-0 sm:w-40 sm:h-36 mr-9  md:mr-0 md:w-52 lg:w-32 lg:h-32 lg:mx-3 lg:bg-cover"
              />
              <di className="lg:p-1">
                <h5 className="sm: text-center font-bold my-2 ">
                  ¡Feliz día del Niño, la mejor tripulación del mundo!
                </h5>
                <p className="sm: py-2">
                  Naabol celebra este día con mucho amor y cariño para todos los
