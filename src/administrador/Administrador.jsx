...
export const Administrador = () => {
  ...
  return (
    <>
     ...
     <div className ="ixed w-full z-30 flex bg-white dark:bg-[#1C2563] p-2 items-center justify-center h-16 px-10">
            ...
            <ol className = "inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    ...
                    <div className = "flex items-center">
                        ...
                        <a href="#" className = "ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white" onClick={handleRefresh}>Subir Noticia</a>
                    </div>
                </li>
            </ol>
        </nav>
